                ...
                <div id="webmax-three" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.1">
                    <ul>
                        ...
                        <li data-index="rs-901" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            data-masterspeed="default" data-thumb="images/main-slider/slider3/slide1.jpg"
                            ...
                            <img src="images/main-slider/slider3/slide1.jpg" alt=""
                                data-lazyload="images/main-slider/slider3/slide1.jpg" data-bgposition="center center"
                                data-kenburns="on" data-duration="10000" data-ease="Power1.easeOut"
                    ...
                    ?>
                            ...
                            <div class="tp-caption tp-resizeme rev-btn" id="slide-901-layer-5"
                                ...
                                <a href="#joinus" class="site-button"> <?php 
                    ...
                    ?></a>
                            ...
                            <div class="tp-caption rev-btn  tp-resizeme slider-block" id="slide-901-layer-7"
                                ...
                                data-textAlign="['right','right','right','right']" data-paddingtop="[200,200,200,200]"
                                data-paddingright="[180,180,180,180]" data-paddingbottom="[200,200,200,200]"
                                data-paddingleft="[180,180,180,180]" style="z-index: 8;">
                            ...
                            <div class="col-lg-7 col-md-12 m-b30">
                                <div class="">
                                    <div class="about-drone-three-media"><img class="shadow-lg rounded"
                                            src="images/gallery/landscape/aboutus.png" alt="" rounded></div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-12 m-b30 how-it-drone2-outer">
                            <div class="how-it-drone2-border">
                                <div class="how-it-drone2">
                                    <div class="how-it-drone-media2"><img src="images/how-it-work/pngeggs.png"
                                            width="200%" height="200%" alt="" class="wave-effects"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="video-style2-left">
                                <div class="video-style2-circle-outer">
                                    ...
                                    <div class="video-style2-media">
                                        ...
                                        <a href="images/video/Promo Nested.mp4" class="mfp-video play-now">
                ...
                <div class="section-content ">
                    ...
                    ?></li>
                                        ...
                                        <div class="pricingtable-footer row">
                                            <div class="col-sm-12">
                                                <a onclick="changePrice()"
                                                    class="text-nowrap col-sm-12 justify-content-center  site-btn-effect2 site-button bg-white border border-danger "
                                                    id="studentButton">I'm a Student</a>
                                            </div>
                                            <div class="col-sm-12">

                                                <a href="javascript:void(0);"
                                                    class="site-button site-btn-effect justify-content-center col-sm-12 mt-4"
                                                    data-target="#myModal1" data-toggle="modal"><?php 
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body bg-white mt-4 z-index-2000000">
                                                                    ...
                                                                    <form action="php/workshop-display.php"
                                                                        class="was-validated " method="POST">
                                                                        <div class="form-group text-left">
                                                                            <label for="uname" class="left">Full
                                                                                Name</label>
                                                                            <input type="text"
                                                                                class="form-control border" id="uname"
                                                                        ...
                                                                        <div class="form-group text-left">
                                                                            ...
                                                                            <input type="text"
                                                                                class="form-control border" id="pwd"
                                                                        ...
                                                                        <div class="form-group text-left">
                                                                            <label
                                                                                for="pwd">Affiliation/Employer</label>
                                                                            <input type="text"
                                                                                class="form-control border" id="pwd"
                                                                                placeholder="Enter your affiliation/employer"
                                                                                name="aff" required>
                                                                            <div class="valid-feedback">Valid.</div>
                                                                            <div class="invalid-feedback">Please fill
                                                                                out this field.</div>
                                                                        ...
                                                                        <div class="form-group text-left">
                                                                            <label for="pwd">Are you a university
                                                                                Student?</label>
                                                                            <input type="radio" id="student-yes"
                                                                                name="student" value="yes">
                                                                            <label class="label"
                                                                                for="student-yes">Yes</label>
                                                                            <input type="radio" id="student-no"
                                                                                name="student" value="no">
                                                                        ...
                                                                        <div class="form-group text-left">
                                                                            <label for="pwd">Do you have any prior
                                                                                background on drones?</label>
                                                                            <input type="radio" id="background-yes"
                                                                                name="background" value="yes">
                                                                            <label class="label"
                                                                                for="background-yes">Yes</label>
                                                                            <input type="radio" id="background-little"
                                                                                name="background" value="little">
                                                                            <label for="background-little">A
                                                                                little</label>
                                                                            <input type="radio" id="background-no"
                                                                                name="background" value="no">
                                                                            <label class="label"
                                                                                for="background-no">No</label>
                                                                            <input type="radio" id="background-other"
                                                                                name="background" value="other">
                                                                            <label class="label"
                                                                                for="background-other">Other</label>
                                                                            <input type="text"
                                                                        ...
                                                                        <button type="submit"
                                                                            class="btn btn-primary text-dark text-center"
                                                                            style="background: inherit; border-color: red;"
                                ...
                                <div class="wt-team-2 shadow-sm">
                                    ...
                                    <div class="wt-info shadow-sm">
                                        <div class="team-detail">
                                            <span
                                                class="title-style-2 team-position site-text-primary"><?php echo $row['role']; ?></span>
                                            <h3 class="m-t0 team-name"><a><?php echo $row['name']; ?></a>
                                            </h3>
                                        </div>
                                        <div class="list-group">

                                            <ul class="team-social-bar text-left"
                                                style="display: -webkit-inline-box; list-style-type:none">

                                                <li><a href="<?php echo $row['twitter']; ?>" target="_blank"><i
                                                            class="fa fa-twitter fa-2x"
                                                            style="color: #00acee; margin: 5px"
                                                            <?php if(strlen($row["twitter"])<5){echo '" hidden "';}?>></i></a>
                                                </li>
                                                <li><a href="<?php echo $row['linkedin']; ?>" target="_blank"><i
                                                            class="fa fa-linkedin fa-2x"
                                                            style="color:#0072b1; margin: 5px"
                                                ...
                                                <li><i class="fa fa-twitter fa-2x"
                                                        style="color: white; margin: 5px"></i></li>
